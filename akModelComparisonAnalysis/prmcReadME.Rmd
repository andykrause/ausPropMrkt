...
Basic order of files:
1. *prmcDataPrep*
2. *prmcDataAnalysis*
3. *prmcDataViz*

(if use raw data from AURIN then data must be built first)
...
Following this, we use the custom function, **applyThres()** to append the designations to each of the observations.
